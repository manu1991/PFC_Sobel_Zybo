...
wire [32 - 1:0] sig_sobel_rows;
wire [32 - 1:0] sig_sobel_cols;
wire sig_sobel_ap_start;
wire sig_sobel_ap_ready;
wire sig_sobel_ap_done;
wire sig_sobel_ap_idle;

wire sig_sobel_ap_rst_n;
...
sobel sobel_U(
    .rows(sig_sobel_rows),
    .cols(sig_sobel_cols),
    .ap_start(sig_sobel_ap_start),
    .ap_ready(sig_sobel_ap_ready),
    .ap_done(sig_sobel_ap_done),
    .ap_idle(sig_sobel_ap_idle),
    .ap_rst_n(sig_sobel_ap_rst_n),
    .ap_clk(aclk),
...
sobel_CONTROL_BUS_if #(
    .C_ADDR_WIDTH(C_S_AXI_CONTROL_BUS_ADDR_WIDTH),
    .C_DATA_WIDTH(C_S_AXI_CONTROL_BUS_DATA_WIDTH))
sobel_CONTROL_BUS_if_U(
    .ACLK(aclk),
    .ARESETN(aresetn),
    .I_rows(sig_sobel_rows),
    .I_cols(sig_sobel_cols),
    .I_ap_start(sig_sobel_ap_start),
    .O_ap_ready(sig_sobel_ap_ready),
    .O_ap_done(sig_sobel_ap_done),
    .O_ap_idle(sig_sobel_ap_idle),
