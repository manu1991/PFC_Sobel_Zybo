...
#ifndef _sobel_Block_proc_HH_
#define _sobel_Block_proc_HH_
...
struct sobel_Block_proc : public sc_module {
    ...
    // Module declarations
    sobel_Block_proc(sc_module_name name);
    SC_HAS_PROCESS(sobel_Block_proc);
    ...
    sc_signal< sc_lv<12> > img_0_rows_V_fu_35_p1;
    sc_signal< sc_lv<12> > img_0_cols_V_fu_31_p1;
    ...
    void thread_img_0_cols_V_fu_31_p1();
    void thread_img_0_rows_V_fu_35_p1();
