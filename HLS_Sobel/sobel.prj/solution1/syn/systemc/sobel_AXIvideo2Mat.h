...
#ifndef _sobel_AXIvideo2Mat_HH_
#define _sobel_AXIvideo2Mat_HH_
...
struct sobel_AXIvideo2Mat : public sc_module {
    ...
    // Module declarations
    sobel_AXIvideo2Mat(sc_module_name name);
    SC_HAS_PROCESS(sobel_AXIvideo2Mat);
    ...
    sc_signal< sc_lv<8> > tmp_60_fu_363_p1;
    sc_signal< sc_lv<8> > tmp_60_reg_444;
    sc_signal< sc_lv<8> > tmp_12_reg_449;
    sc_signal< sc_lv<8> > tmp_14_reg_454;
    ...
    sc_signal< sc_lv<32> > axi_data_V_3_reg_276;
    sc_signal< sc_lv<32> > axi_data_V1_reg_163;
    sc_signal< sc_lv<12> > p_s_reg_173;
    sc_signal< sc_lv<1> > eol_1_phi_fu_187_p4;
    sc_signal< sc_lv<32> > axi_data_V_1_phi_fu_198_p4;
    sc_signal< sc_lv<1> > eol_phi_fu_221_p4;
    sc_signal< sc_lv<1> > ap_reg_phiprechg_axi_last_V_2_reg_229pp1_it0;
    sc_signal< sc_lv<32> > ap_reg_phiprechg_p_Val2_s_reg_241pp1_it0;
    sc_signal< sc_lv<32> > p_Val2_s_phi_fu_245_p4;
